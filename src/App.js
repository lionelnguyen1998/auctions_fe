...
import Sell from './pages/Auction/Sell';
import Item from './pages/Item/Item';
import AuthService from "./components/services/auth.service";
import Detail from './pages/Auction/Detail';
import DetailWait from './pages/Auction/DetailWait';
import Auctions from './pages/Auction/Auctions';
import AuctionsK from './pages/Auction/AuctionsK';
import Like from './pages/Like/Like';
import New from './pages/News/New';
import ReadNew from './pages/News/ReadNew';
import AuctionByCategory from './pages/Category/AuctionByCategory';
import AuctionByTypeCategory from './pages/Category/AuctionByTypeCategory';
